...
protected:
	...
	int IssueCANCommand(std::string commandType, std::string id, std::string command, std::string args, int waitms, std::string &response, bool isplusminus = false);
...
public:
	...
	int SetCANCommand(int id, int commandItem, int index, int value);
